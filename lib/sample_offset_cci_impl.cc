...
namespace doa {
              ...
              gr::io_signature::make(1, 1, sizeof(int)))
    {
        ...
        d_fft = new gr::fft::fft_complex_fwd(d_fft_width, 1);
        d_ifft = new gr::fft::fft_complex_rev(d_fft_width, 1);

        message_port_register_in(pmt::mp("recalc"));
        set_msg_handler(pmt::mp("recalc"), [this](const pmt::pmt_t& msg) { sample_offset_cci_impl::recalc_msg(msg); });
    }
